...
builder.Services.AddSingleton<RecipeApi.Features.HeftyMesterskapet.IHeftyMesterskapetHandoffStore>(
    _ => new RecipeApi.Features.HeftyMesterskapet.HeftyMesterskapetHandoffStore());
