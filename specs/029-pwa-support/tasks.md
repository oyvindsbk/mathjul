...
- [x] **T3** Create `public/manifest.json`: `name: "Matoppskrifter"`, `short_name: "Mathjul"`, `display: "standalone"`, `start_url: "/"`, `lang: "no"`, `theme_color: "#0f172a"`, `background_color: "#ffffff"`, icons array (192 + 512).
